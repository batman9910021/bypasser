...
# bot
bot_token = os.environ.get("TOKEN", "5855800728:AAFNumvlGQuCBI6g9ZvWN2iiZcIqIv-AHpU")
api_hash = os.environ.get("HASH", "dcb6bfd6d51a8ff5f6aadb01b9fdd11b") 
api_id = os.environ.get("ID", "21879629")
...
def send_start(client: pyrogram.client.Client, message: pyrogram.types.messages_and_media.message.Message):
    ...
    reply_markup=InlineKeyboardMarkup([[ InlineKeyboardButton("🌐 Source Code", url="https://t.me/AKImaxPremium")]]), reply_to_message_id=message.id)
